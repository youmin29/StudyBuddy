            ...
            {status === "success" && (
              <div className="text-center py-4">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #A8D8F0 0%, #A78BFA 100%)",
                  }}
                >
            ...
            {status === "error" && (
              <div className="text-center py-4">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #FFB6D9 0%, #FF6B9D 100%)",
                  }}
                >
            ...
            {status === "idle" && (
              <>
                ...
                <button
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(168,216,240,0.3) 0%, rgba(167,139,250,0.3) 100%)",
                    border: "2px solid rgba(168,216,240,0.5)",
                    boxShadow:
                      "inset 0 1px 0 rgba(255,255,255,0.8), 0 2px 8px rgba(168,216,240,0.2)",
                  }}
                >
                  <div className="flex items-center gap-3">
                    <div
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #FFC9E5 0%, #D4A5F5 100%)",
                      }}
                    >
